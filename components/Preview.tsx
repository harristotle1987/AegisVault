...
export const Preview: React.FC<PreviewProps> = ({ content, font = 'sans', activeDocId }) => {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div ref={scrollContainerRef} className="flex-1 overflow-y-auto bg-obsidian-soft no-scrollbar vault-editor-scroll">
        <div className="max-w-4xl mx-auto min-h-full flex flex-col shadow-[0_0_100px_rgba(0,0,0,0.4)]">
          <div id="preview-area" ref={previewRef} className={`flex-1 p-8 md:p-24 pb-[300px] prose-vault selection:bg-emerald-vault/20 ${fontClass}`} />
