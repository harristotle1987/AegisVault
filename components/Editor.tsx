  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <textarea
        ...
        className="flex-1 bg-obsidian p-8 focus:outline-none resize-none font-mono text-sm leading-relaxed text-vault-text placeholder:text-zinc-800 caret-emerald-vault"
